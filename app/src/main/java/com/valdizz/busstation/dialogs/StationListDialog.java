...
import com.valdizz.busstation.database.RoutesOnStationCursorLoader;
...
public class StationListDialog extends AppCompatDialogFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bundle.putStringArray(DatabaseAccess.BUNDLE_PARAMS, new String[]{getTag()});
    ...
    private final SimpleCursorAdapter.ViewBinder scRoutesOnStationAdapterBinder = new SimpleCursorAdapter.ViewBinder() {
        @Override
